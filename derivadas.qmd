...
plot_line(function(x) {0.5*x + 4}, 
  ...
  annotate("text", x = -5, y = 0.5,color = "purple", label = "m = tg x") +
...
grafico_circulo_unitario <- plot_line(function(x) {0.5*x}, 
          x_start = -1.1, 
          x_end = 1.1,
          y_start = -1.1,
          y_end = 1.1) +
...
circulo_unitario_com_linhas <- grafico_circulo_unitario +
  ...
  annotate("text", x = 0.5, y = 0.05, label = "a", color = "blue") +
    annotate("text", x = 1.05, y = 0.4, label = "tg x", color = "purple") +
...
$$
\frac{\tan x}{1} = \frac{b}{a}
$$

No gráfico acima, $b = \sin x$ e $a = \cos x$.
