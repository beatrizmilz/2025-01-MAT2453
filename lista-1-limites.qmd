...
### 8. TO DO - Primeiro limite fundamental, substituição de variável, fatoração
...
$$
= \lim_{x \to 4} \frac{\frac{\sin(x-4)}{\cos(x-4)}}{(x-4)(x+4)}
$$

Vamos dividir em cima e em baixo por $x-4$:

$$
= \lim_{x \to 4} \frac{\frac{\sin(x-4)}{\cos(x-4) \cdot {(x-4)}}}{\frac{(x-4)(x+4)}{(x-4)}}
$$
Vamos simplificar:

$$
= \lim_{x \to 4} \frac{\frac{\sin(x-4)}{ {(x-4)} }
\cdot \frac{1}{\cos(x-4)}
...
$$
x - 4 = u \implies x - 4  \color{red}{+ 8} \color{black}{ = u  } \color{red}{+8}  \color{black}{\implies x + 4 = u + 8}
$$

Podemos usar o primeiro limite fundamental:

$$
= \lim_{u \to 0} \frac{\cancelto{1}{\frac{\sin u}{ {u} }}
\cdot \frac{1}{\cos u }
}{(u + 8)}
$$

$$
= \lim_{u \to 0} \frac{\frac{1}{\cos u}
}{(u + 8)}
$$

> Mas ainda temos o $cos u$. Precisamos chegar no limite fundamental!
...
### 11. TO DO - Racionalização, fatoração
...
> O passo abaixo é "lícito"? Entender melhor.

$$
=\lim_{x \to +\infty}  \frac{-3x}{x \cdot (1+\sqrt{1+\frac{3}{x}})}
$$
